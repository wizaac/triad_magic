...
wave tags 
wave update off
wave zoom range 0 170002195000
...
wave add -group {Chord Channel 0 Wishbone internal} triad_magic_tb.dut.ch0.wb_rdat -tag sim -radix hexadecimal
...
wave add -group {Display:Disp Wishbone Top} triad_magic_tb.dut.ch0.disp.wb_wdat -tag sim -radix hexadecimal
...
wave group {Display:Disp Wishbone Top} -collapse
wave group {ADC:ADC Registers} -collapse
wave group {ADC:ADC SPI Wishbone} -collapse
wave group {ADC:ADC Wishbone Top} -collapse
wave group {Chord Channel 0 Wishbone internal} -collapse
wave group {Forklift State Machine} -collapse
